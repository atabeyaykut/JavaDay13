...
public class WordCounter {
    ...
    public static Map<String, Integer> calculatedWord() {
        String text = "When the offensive resumed, the Turks received their first victory when the Greeks encountered stiff resistance in the battles of First and Second İnönü, due to İsmet Pasha's organization of an irregular militia into a regular army. " +
